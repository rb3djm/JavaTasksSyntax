...
public class Month {
    ...
    public static int ordinal(Month month){
        return month.getMonthNum();
    }

    private static final Month[] MONTH_2_ARRAY = {JANUARY, FEBRUARY, MARCH, APRIL, MAY, JUNE, JULY, AUGUST, SEPTEMBER, OCTOBER, NOVEMBER, DECEMBER};
